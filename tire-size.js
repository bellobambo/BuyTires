  ...
  const formHTML = `
        <div class="staggered-form">
            ...
            <div class="form-row">
                ...
                <select id="rearProfile">${generateOptions(
            ...
            <div class="form-row">
                ...
                <select id="rearWheelSize">${generateOptions(
            ...
            <div class="form-row">
                ...
                <select id="rearSeason">${generateOptions(
            ...
            <div class="form-row">
                ...
                <select id="rearSpeed">${generateOptions(
            ...
            <div class="form-row">
                ...
                <select id="rearLoad">${generateOptions(
